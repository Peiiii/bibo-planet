...
已登录旅人可以在页首点击「导出我的数据」，下载自己的账号基本资料、与三只精灵的对话，以及自己贡献给共同世界的遭遇记录；不会包含其他旅人的原文或密码、会话哈希。文件可能含私人内容，请妥善保存。该入口不等于删除账号，也无法自动找出其他旅人收到的衍生回复；后续权利路径仍在[上线验收记录](docs/plans/2026-09-24-public-launch.plan.md)中跟进。
