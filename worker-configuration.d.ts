/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c2ebc77a3da2d027506f56cbbebb1fc7)
// Runtime types generated with workerd@1.20260921.1 2026-09-24 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	BIBO_ORIGIN: "https://nextclaw.net";
	BIBO_EDGE_SECRET: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/edge/worker");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BIBO_ORIGIN" | "BIBO_EDGE_SECRET">> {}
}
